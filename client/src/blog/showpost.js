...
class ShowPost extends Component{
    ...
    componentDidMount(){
        axios.get('/api/post/allpostcomments', {params: {post_id :this.props.location.state.post.post.pid}})
  ...
  handleSubmit= (event) =>{
    ...
    const data= {comment: event.target.comment.value, post_id, user_id: user_id, username: username}
  ...
  handleUpdate =() =>{
      ...
      const data= {cid: cid, comment: comment.value, post_id, user_id: user_id, username: username}
